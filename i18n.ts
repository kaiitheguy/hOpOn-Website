...
> = {
  en: {
    ...
    failedTitle: 'Failed',
    tryAgain: 'Try again',
    notConfigured: 'Redeem is not configured. Set VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY in .env.',
    errors: {
  ...
  zh: {
    ...
    failedTitle: '兑换失败',
    tryAgain: '再试一次',
    notConfigured: '未配置兑换功能。请在 .env 中设置 VITE_SUPABASE_URL 和 VITE_SUPABASE_ANON_KEY。',
    errors: {
